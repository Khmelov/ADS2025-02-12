...
- **Диффузия**: изменение одного бита во входных данных должно приводить к изменению примерно половины битов в выходном хеше (эффект лавины).  
- **Конфузия**: связь между входными данными и выходным хешем должна быть сложной и нелинейной.  
