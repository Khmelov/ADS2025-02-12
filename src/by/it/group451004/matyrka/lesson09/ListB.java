...
public class ListB<E> implements List<E> {
    ...
    public E remove(int index) {
        if (index < 0 || index >= usedLength)
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + usedLength);
    ...
    public void add(int index, E element) {
        ...
        // Исправлено: разрешаем index == usedLength (добавление в конец)
        if (index < 0 || index > usedLength)
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + usedLength);
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        // Исправлено: правильная проверка границ
        if (fromIndex < 0 || toIndex > usedLength || fromIndex > toIndex)
            throw new IndexOutOfBoundsException("fromIndex: " + fromIndex + ", toIndex: " + toIndex + ", size: " + usedLength);
    ...
    public <T> T[] toArray(T[] a) {
        if (a.length < usedLength) {
            // Исправлено: убрано неправильное приведение типов
            return (T[]) Arrays.copyOf(arr, usedLength, a.getClass());
        } else {
            System.arraycopy(arr, 0, a, 0, usedLength);
            if (a.length > usedLength) {
                a[usedLength] = null;
            }
            return a;
