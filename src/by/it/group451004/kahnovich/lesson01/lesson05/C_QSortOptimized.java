package by.it.group451004.kahnovich.lesson01.lesson05;
...
public class C_QSortOptimized {
    ...
    int[] getAccessory2(InputStream stream) throws FileNotFoundException {
        ...
        //читаем сами отрезки СОРТИРУЕМ МАССИВ SEGMENTS БЕЗ СОЗДАНИЯ ДОП МАССИВОВ
        for (int i = 0; i < n; i++) {
            //читаем начало и конец каждого отрезка СОЗДАЁМ ОБЪЕКТЫ СЕГМЕНТА ДЛЯ КАЖДОГО ИНТЕРВАЛА
