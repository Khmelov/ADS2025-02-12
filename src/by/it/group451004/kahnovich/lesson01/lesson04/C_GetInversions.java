...
public class C_GetInversions {
    ...
    int merge(int[] arr, int left, int mid, int right) {
        // Копируем левую и правую части массива
        ...
        // Слияние двух подмассивов с подсчётом инверсий
        while (i < arrFirst.length && j < arrSecond.length) {
            if (arrFirst[i] <= arrSecond[j]) {
                // Если элемент из первого подмассива меньше - инверсий нет
                arr[k] = arrFirst[i];
                i++;
            } else {
                // Если элемент из второго подмассива меньше, то он образует инверсии
                // со всеми оставшимися элементами первого подмассива
