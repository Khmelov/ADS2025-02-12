package by.it.group451004.momotyuk.lesson01;
...
//    }
//
//    BigInteger[][] MultiplyMatrices(BigInteger[][] MyArrayDeque.java, BigInteger[][] B){ //тут плохо, квадратичная сложность
//        BigInteger[][] MultipliedMatrix = new BigInteger[2][2];
//        MultipliedMatrix[0][0] = MyArrayDeque.java[0][0].multiply(B[0][0]).add(MyArrayDeque.java[0][1].multiply(B[1][0]));
//        MultipliedMatrix[0][1] = MyArrayDeque.java[0][0].multiply(B[0][1]).add(MyArrayDeque.java[0][1].multiply(B[1][1]));
//        MultipliedMatrix[1][0] = MyArrayDeque.java[1][0].multiply(B[0][0]).add(MyArrayDeque.java[1][1].multiply(B[1][0]));
//        MultipliedMatrix[1][1] = MyArrayDeque.java[1][0].multiply(B[0][1]).add(MyArrayDeque.java[1][1].multiply(B[1][1]));
