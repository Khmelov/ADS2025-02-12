package by.it.group451004.momotyuk.lesson06;
...
Дано:
    ...
    массив MyArrayDeque.java[1…n] натуральных чисел, не превосходящих 2E9.

Необходимо:
    Выведите максимальное 1<=k<=n, для которого гарантированно найдётся
    подпоследовательность индексов i[1]<i[2]<…<i[k] <= длины k,
    для которой каждый элемент MyArrayDeque.java[i[k]] не больше любого предыдущего
    т.е. для всех 1<=j<k, MyArrayDeque.java[i[j]]>=MyArrayDeque.java[i[j+1]].

    В первой строке выведите её длину k,
    во второй - её индексы i[1]<i[2]<…<i[k]
    соблюдая MyArrayDeque.java[i[1]]>=MyArrayDeque.java[i[2]]>= ... >=MyArrayDeque.java[i[n]].
