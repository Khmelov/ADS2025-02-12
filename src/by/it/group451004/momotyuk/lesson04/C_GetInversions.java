package by.it.group451004.momotyuk.lesson04;
...
вторая - массив MyArrayDeque.java[1…n], содержащий натуральные числа, не превосходящие 10E9.
Необходимо посчитать число пар индексов 1<=i<j<n, для которых MyArrayDeque.java[i]>MyArrayDeque.java[j].
