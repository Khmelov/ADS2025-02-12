package by.it.group410902.bolshakova.lesson07;
...
public class C_EditDist {
    ...
    String getDistanceEdinting(String one, String two) {
        ...
        // Разворот результата для правильного порядка
        String[] steps = result.toString().split(",");
        StringBuilder finalResult = new StringBuilder();
        for (int k = steps.length - 1; k >= 0; k--) {
            if (!steps[k].isEmpty()) {
                finalResult.append(steps[k]).append(",");
            }
        }
