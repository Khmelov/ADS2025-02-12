package by.it.group451002.kita.lesson13;
...
это максимальное множество вершин, где из любой вершины можно достичь любую другую.
P.S. При равнозначности вершин в компоненте порядок их вывода - лексикографический (т.е. по алфавиту)
 */
public class GraphC {public static void main(String[] args) {
